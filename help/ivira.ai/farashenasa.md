...
* با توجه به اینکه سرویس فراشناسا تمام درخواست های احراز هویت را در یک مرحله انجام می دهد و امکان ایجاد خطاهای غیر منتظره ای مانند قطع شدن اینترنت، محدودیت سرورهای فراشناسا و.. وجود دارد لطفا در پیاده سازی و استفاده از سرویس فراشناسا از سیستم صف در لاراول برای مدیریت بهتر درخواست استفاده نمایید.